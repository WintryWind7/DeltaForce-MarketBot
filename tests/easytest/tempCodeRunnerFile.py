...
print("=" * 80)
print("EasyOCR vs PaddleOCR 性能对比测试")
print("=" * 80)
...
start_time = time.time()
# 使用自定义数字字典
paddle_ocr = PaddleOCR(use_textline_orientation=True, lang='en', rec_char_dict_path='en_dict.txt')
...
for img_path in test_images:
    ...
    if result and len(result) > 0:
        # PaddleOCR 返回的是字典列表,识别文本在 'rec_texts' 字段
    ...
    print(f"  {img_path}: {digits_only} ({ocr_time:.4f}秒)")
